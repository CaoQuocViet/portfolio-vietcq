                        ...
                        <div>
                            ...
                            <div className="space-y-6">
                                {projectData.features.map((feature, index) => (
                                    <div
                                        key={index}
                                        className="group relative overflow-hidden rounded-xl p-6 transition-all duration-500 hover:scale-[1.02] bg-[var(--bg-card)] border border-[var(--border-default)] hover:border-[var(--border-hover)] hover:shadow-[var(--card-shadow-hover)]"
                                    >
                    ...
                    {projectData.achievements && (
                        <div>
                            ...
                            {projectData.achievements.metrics && projectData.achievements.metrics.length > 0 && (
                                <div className="mb-10">
                                    <h4 className="text-lg font-semibold mb-6 flex items-center gap-2 text-[var(--text-body)]">
                                        <div className="w-2 h-2 rounded-full bg-[var(--btn-primary)]" />
                                        Key Metrics
                                    </h4>
                                    <div className="space-y-4">
                                        {projectData.achievements.metrics.map((metric, index) => (
                                            <div
                                                key={index}
                                                className="group relative overflow-hidden rounded-xl p-5 transition-all duration-500 hover:scale-[1.02] bg-[var(--bg-card)] border border-[var(--border-default)] hover:border-[var(--border-hover)] hover:shadow-[var(--card-shadow-hover)]"
                                            >
                                                <div className={`absolute inset-0 bg-gradient-to-r ${gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-500`} />
