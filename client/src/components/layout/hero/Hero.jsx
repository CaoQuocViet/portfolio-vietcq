        ...
        <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-32 pb-16 text-center relative z-10">
                <div style={{ animation: 'fadeInUp 1s ease-out' }}>
                    <p className={`text-lg font-medium mb-6 text-[var(--text-link)] ${showCursor ? 'typing-cursor' : ''}`} style={{ animation: 'fadeInUp 1s ease-out 0.2s both' }}>
                    ...
                    <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed text-[var(--text-secondary)]" style={{ animation: 'fadeInUp 1s ease-out 0.6s both' }}>
                        {t('hero.tagline')}
                    </p>
                    ...
                    <div className="flex justify-center space-x-6 mb-16" 
                        ...
                        {[
                            ...
                            <Link
                                ...
                                href={href}
                                target="_blank"
                                className="p-3 rounded-full transition-all duration-300 transform hover:scale-110 text-[var(--text-muted)] hover:text-[var(--text-heading)] hover:bg-[var(--bg-hover)]"
                                aria-label={label}
                            >
                                <Icon size={24} />
                            </Link>
